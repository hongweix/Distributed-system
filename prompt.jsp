<%-- 
    Document   : result
    Created on : Feb 2, 2016, 3:37:11 PM
    Author     : Hongwei Xie
--%>
<%-- This is the prompt page that let user to input. --%>
...
<html>
    <head>
        ...
        <%-- Set the page background to be a picture of a bird. --%>
        <style>
        body {
            background-image: url("https://ids.si.edu/ids/deliveryService?max_w=400&id=http%3A%2F%2Fnationalzoo.si.edu/scbi/migratorybirds/featured_photo/images/bigpic/noca58.jpg");
    ...
    <body>
        <p>Search the <p>
            <%-- Set the link to an web page. --%>
        <p><a href="http://nationalzoo.si.edu/scbi/migratorybirds/featured_photo/" target="_blank">
            Smithsonian Migratory Bird Center Bird Photo Gallery
                </a></p>
        <p>for images of migratory birds.</p>
        <%--  Connect to SearchBird servelet and call doGet method. --%>
        <form action="getAnBirdPicture" method="GET" >
            <%--  Drop box code from migratorybirds web page. --%>
            <div class="form-group">  
                <label for="tags" class="sr-only">Select a bird to display: </label>
